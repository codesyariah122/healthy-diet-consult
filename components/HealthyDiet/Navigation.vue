...
<template>
	<nav class="bg-emerald-500 text-white border-emerald-500 fixed top-0 z-50 w-full shadow-lg">
		<div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
			<a href="https://flowbite.com" class="flex items-center space-x-3 text-3xl rtl:space-x-reverse">
				<font-awesome-icon icon="fa-solid fa-notes-medical" />
				<span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Healthy Diet</span>
			</a>
			<button @click="toggleMenu" data-collapse-toggle="mega-menu-full" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white hover:text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500" aria-controls="mega-menu-full" aria-expanded="false">
			...
			<div id="mega-menu-full" class="items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1">
				<ul class="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-emerald-500 font-semibold">
					<li>
		...
		<div  v-show="isMenuOpen" id="mega-menu-full-dropdown" class="border-emerald-500 shadow-sm bg-emerald-500 md:bg-emerald-500 border-y">
